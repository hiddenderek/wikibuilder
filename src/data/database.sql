...
CREATE TABLE page_contributions (id UUID NOT NULL PRIMARY KEY, user_id UUID REFERENCES users(id), page_id UUID REFERENCES pages(id), action_type TEXT NOT NULL, time_executed TIMESTAMP NOT NULL);
